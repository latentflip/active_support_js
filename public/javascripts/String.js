(function() {
  ...
  String.prototype.singularize = function() {
    var s;
    console.log(this.slice(0), this.slice(0).pluralize(), this.slice(0, -1).pluralize(), this.slice(0, -2).pluralize());
    s = null;
    if (this.slice(0, -2).pluralize() === this.slice(0)) {
      if (s == null) {
        s = this.slice(0, -2);
      }
    }
    if (this.slice(0).pluralize() === this.slice(0)) {
      if (s == null) {
        s = this.slice(0);
      }
    }
    if (this.slice(0, -1).pluralize() === this.slice(0)) {
      if (s == null) {
        s = this.slice(0, -1);
      }
    }
